...
export const helpdata: { icon: string; title: string; text: string }[] = [
  {
    icon: assetPath("/images/help/help-icon-3.svg"),
  ...
  {
    icon: assetPath("/images/help/help-icon-2.svg"),
  ...
  {
    icon: assetPath("/images/help/help-icon-1.svg"),
...
export const CauseData: {
  ...
  {
    image: assetPath("/images/app-home.png"),
  ...
  {
    image: assetPath("/images/causes/cause-2.jpg"),
  ...
  {
    image: assetPath("/images/causes/cause-3.jpg"),
  ...
  {
    image: assetPath("/images/causes/cause-4.jpg"),
  ...
  {
    image: assetPath("/images/causes/cause-5.jpg"),
  ...
  {
    image: assetPath("/images/causes/cause-6.jpg"),
  ...
  {
    image: assetPath("/images/causes/cause-7.jpg"),
  ...
  {
    image: assetPath("/images/causes/cause-8.jpg"),
  ...
  {
    image: assetPath("/images/causes/cause-9.jpg"),
...
export const Eventdata: {
  ...
  {
    image: assetPath("/images/event/event-img-1.jpg"),
  ...
  {
    image: assetPath("/images/event/event-img-2.jpg"),
  ...
  {
    image: assetPath("/images/event/event-img-3.jpg"),
  ...
  {
    image: assetPath("/images/event/event-4.jpg"),
  ...
  {
    image: assetPath("/images/event/event-5.jpg"),
  ...
  {
    image: assetPath("/images/event/event-6.jpg"),
...
export const Reviews: {
  ...
  {
    clientImg: assetPath("/images/testimonial/customer-img-1.jpg"),
  ...
  {
    clientImg: assetPath("/images/testimonial/customer-img-2.jpg"),
  ...
  {
    clientImg: assetPath("/images/testimonial/customer-img-3.jpg"),
  ...
  {
    clientImg: assetPath("/images/testimonial/customer-img-4.jpg"),

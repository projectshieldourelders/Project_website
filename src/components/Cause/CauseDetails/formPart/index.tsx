                ...
                <form className="">
                    <div className="grid md:grid-cols-2 grid-cols-1 gap-7 mb-7">
                        <div className="flex flex-col">
                            <label htmlFor="Fname" className="text-base text-muted dark:text-white/85 mb-4">First name *</label>
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="Lname" className="text-base text-muted dark:text-white/85 mb-4">Last name</label>
                    ...
                    <div className="flex flex-col mb-7">
                        <label htmlFor="Email" className="text-base text-muted dark:text-white/85 mb-4">Email address *</label>
                    ...
                    <div className="flex flex-col mb-7">
                        <label htmlFor="Site" className="text-base text-muted dark:text-white/85 mb-4">Organization or family group</label>

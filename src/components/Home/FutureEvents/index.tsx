    ...
    <section className="lg:py-28 py-16 dark:bg-dark">
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4">
        ...
        <div className="flex flex-col items-center gap-12">
          ...
          <Link href="/events" className="text-white text-base bg-primary px-7 py-4 border font-semibold border-primary hover:border-primary hover:bg-transparent hover:text-primary rounded-md cursor-pointer" >View All Workshops</Link>
        </div>
      </div>
    </section>
  );

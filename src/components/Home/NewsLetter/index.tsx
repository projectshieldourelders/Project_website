  ...
  return (
    <section className="lg:py-28 py-16 dark:bg-dark">
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4">
        <div className="flex flex-col lg:flex-row lg:gap-44 lg:[&>*]:flex-1">
          <div className="" data-aos="fade-left">
            <div className="mb-8">
              ...
              <p className="text-base text-dustGray dark:text-white/85">
                Get brief notes about workshop progress, common scam patterns,
                app updates, and local evidence.
              </p>
            </div>
            <form>
              <div className="mb-6">
              ...
              <div className="flex justify-center mb-6">
                <button
                  type="submit"
                  className="text-white  bg-linear-to-r from-error to-warning px-7 py-4 dark:hover:from-dark hover:from-white hover:to-white dark:hover:to-dark border border-transparent hover:border-error hover:text-error rounded-sm w-full cursor-pointer"
                >
                  Subscribe
                </button>
              </div>
          ...
          <div className="lg:mt-0 mt-8">
            <div className="flex justify-between items-center border-b border-border dark:border-dark_border focus:border-primary dark:focus:border-primary dark:bg-dark pb-6 mb-8 focus-visible:outline-none-10">
              <h2 className="text-3xl font-semibold">
                Latest scam-safety notes
              </h2>
              <Link
                href="/blog"
                className="text-error hover:text-primary text-base"
              >
                View all
              </Link>
            </div>

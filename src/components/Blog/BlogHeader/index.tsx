                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                        <div className="col-span-8">
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <span className="text-base text-midnight_text sm:pl-7 pl-0 w-fit">Scam safety note</span>
                            </div>
                        ...
                        <div className="flex  gap-6 col-span-4 pt-4 md:pt-0">
                            ...
                            />
                            <div>
                                <span className="text-[22px] leading-tight text-midnight_text">Shield Our Elders</span>
